...
#define ADC_PIN 34         // GPIO 34 , uses any valid Ax pin as you wish
#define DAC DAC_CHANNEL_1  // GPIO 25 (DAC_CHANNEL_1) or 26 (DAC_CHANNEL_2)
...
void setup() {
    dac_output_enable(DAC);    // pin 25 or 26
